...
export const productData: Record<StepId, StepConfig> = {
  ...
  wheel: {
    ...
    products: [
      ...
      { id: "gte-wheel", name: "Ferrari GTE", url: "https://support.thrustmaster.com/en/product/ferrarigtewheeladdonf458-en/", price: 169, image: "/src/assets/ferrari-gte-wheel.png" },
